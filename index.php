		...
		<div style="text-align:center;color:red;font-weight:900"> <?php
                        ...
                        if(isset($_GET["error"]))
                            ...
                            <div class="alert alert-danger">
                             <i class="glyphicon glyphicon-warning-sign"></i> &nbsp; <?php echo "No hay registro con esa cedula!"; ?> 
                         </div>
                         <?php
                     }
...
<?php
      ...
      <input type="text" class="form-control" name="motivo" maxlength="50"  placeholder="motivo" required="" autofocus="" />  
